export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Tetrel Notebook não pôde ser alcançado",
    ...
    docLink: "Documentação do Tetrel Notebook",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Tetrel Notebook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Tetrel Notebook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Tetrel Notebook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Tetrel Notebook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Tetrel Notebook.",

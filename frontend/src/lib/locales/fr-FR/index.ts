export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Tetrel Notebook est injoignable",
    ...
    docLink: "Documentation de Tetrel Notebook",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Tetrel Notebook à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Tetrel Notebook est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Tetrel Notebook",
    missingRequiredModels: "Modèles requis manquants : {models}. Tetrel Notebook pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Tetrel Notebook.",

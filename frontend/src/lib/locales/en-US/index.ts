export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Tetrel Notebook API server could not be reached",
    ...
    docLink: "Tetrel Notebook Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Tetrel Notebook to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Tetrel Notebook is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  transformations: {
    ...
    overrideModelDesc: "Override the default model for this chat session. Leave blank to use the system default.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Tetrel Notebook",
    missingRequiredModels: "Missing required models: {models}. Tetrel Notebook may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Tetrel Notebook.",
  ...
  compliance: {
    title: "CSET Regulatory Compliance Hub",
    subtitle: "Replicating CISA CSET library configurations: 60+ frameworks, cross-examination matrices, and maturity evaluations",
    allSectors: "All Sectors",
    searchPlaceholder: "Search CSET standard libraries...",
    activeStandards: "Active Standards",
    matrixTitle: "Framework Mapping comparison matrix",
    matrixDesc: "Compare control densities and standard indices side-by-side",
    questions: "Questions",
    levels: "Levels",
    more: "MORE",
    ...
    iecCode: "IEC 62443 Standard Code",
    nistIndex: "NIST SP 800-82 Index",
    nercRequirement: "NERC CIP Requirement",
    domains: {
      boundaryProtection: "Boundary Protection",
      networkSegmentation: "Network Segmentation",
      fieldZoneSecurity: "Field Zone Security",
      accessManagement: "Access Management",
      incidentLogging: "Incident Logging",
    },
    sr51: "SR 5.1 (Level 3 Boundary)",
    section623: "Section 6.2.3 (DMZ Mediation)",
    cip0057_perimeter: "CIP-005-7 (Electronic Perimeter)",
    sr52: "SR 5.2 (Process Segmentation)",
    section624: "Section 6.2.4 (Firewall Rules)",
    cip0057_isolation: "CIP-005-7 R1.2 (Access Isolation)",
    sr54: "SR 5.4 (Cryptographic Diode)",
    section625: "Section 6.2.5 (Field Port Lockdown)",
    cip0066_field: "CIP-006-6 (Physical Security Field)",
    sr11: "SR 1.1 (Multi-Factor Auth)",
    section611: "Section 6.1.1 (Auditor Access)",
    cip0046_personnel: "CIP-004-6 (Personnel Authorization)",
    sr61: "SR 6.1 (Audit Log Integrity)",
    section632: "Section 6.3.2 (Syslog Aggregator)",
    cip0076_logging: "CIP-007-6 R4 (Logging & Auditing)",
    wizard: {
      ...
      backToGrid: "[ Back to Framework Grid ]",
      standardLabel: "{sector} STANDARD",
      standardOverview: "STANDARD OVERVIEW",
      metadataType: "METADATA TYPE",
      totalChecks: "TOTAL CHECKS",
      directivesCount: "{count} Directives",
      maturityMatrix: "CSET MATURITY LEVEL MATRIX",
      radarTitle: "Compliance Radar analytics",
      verified: "Verified",
      maturityStatus: "Maturity Status",
      statusSummary: "{yCount} YES • {altCount} ALT",
      refManual: "Reference Manual",
      interactiveEvaluation: "Interactive Evaluation",
      percentComplete: "{progress}% Evaluation Complete",
      introScope: "I. Introduction & Regulatory Scope",
      maturitySpecs: "II. Maturity / Level Specifications",
      reqsCatalog: "III. Framework Requirements Catalog",
      loadingControls: "Loading active compliance controls...",
      reqsCount: "{count} Requirements",
      checksCount: "{count} Checks",
      purdueLevelLabel: "Purdue Level {level}",
      purdueLevels: {
        level0: "Physical Access Control",
        level1: "Sensor / Actuator Safety",
        level2: "Local HMI Diagnostic",
        level3: "Operations / SCADA Controller",
        level4: "Zone Gateway Boundary",
        level0_desc: "Device Diagnostic Port / Physical",
        level1_desc: "Field Instrumentation / Safety Systems",
        level2_desc: "Local Supervisor / HMI Console",
        level3_desc: "Operations Network / SCADA",
        level4_desc: "Enterprise / External DMZ Boundary",
      },
      answerChecklist: "Answer Checklist",
      noGuidance: "No direct educational guidance available.",
      searchControlsPlaceholder: "Search current framework controls by code or text...",
      noControlsFound: "No matching controls found.",
      education: "Education",
      signedWaiver: "Signed Compensating Control / Rationale Waiver",
      describeWaiver: "Describe alternating security controls compensating for this check...",
      auditorRationaleRequired: "Auditor Compliance Rationale / Mitigation Plan Required",
      describeMitigation: "Describe scheduled mitigation plans or non-compliance rationale...",
      pageStatus: "Page {current} of {total} ({count} checks found)",
      prev: "Prev",
      next: "Next",
      guidanceEducation: "Guidance & Education",
      controlDirective: "CONTROL DIRECTIVE",
      purdueZoneLevel: "PURDUE ZONE LEVEL",
      csetGuidelines: "CSET EDUCATIONAL DESCRIPTION & GUIDELINES",

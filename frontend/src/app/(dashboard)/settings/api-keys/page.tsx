    ...
    return (
      <AppShell>
        <div className="flex-1 p-6">
          <DataPageSkeleton layout="cards-grid" count={6} />
        </div>
      </AppShell>
    )
  }
        ...
        <div className="p-6 space-y-6">
          ...
          {viewMode === 'cards' ? (
            ...
            <div className="space-y-1">
              {/* Column headers */}
              <div className="grid grid-cols-[1fr_90px_80px_90px_140px_100px] items-center gap-2 px-4 py-1.5 text-[10px] font-medium text-muted-foreground uppercase tracking-wider">
                <span>Provider</span>
                <span>Status</span>
                <span>Key</span>
                <span>Models</span>

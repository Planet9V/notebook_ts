...
export const ALL_PROVIDERS = [
  ...
  'huggingface', 'mapbox',
  'dashscope', 'minimax', 'voyage', 'elevenlabs', 'deepgram', 'ollama',
...
export const TYPE_ICONS: Record<ModelType, React.ReactNode> = {
  language: React.createElement(MessageSquare, { className: 'h-3 w-3' }),
  embedding: React.createElement(Code, { className: 'h-3 w-3' }),
  reranking: React.createElement(ArrowUpDown, { className: 'h-3 w-3' }),
  image_generation: React.createElement(ImageIcon, { className: 'h-3 w-3' }),
  audio: React.createElement(Music, { className: 'h-3 w-3' }),
  video: React.createElement(Film, { className: 'h-3 w-3' }),
  text_to_speech: React.createElement(Volume2, { className: 'h-3 w-3' }),
  speech_to_text: React.createElement(Mic, { className: 'h-3 w-3' }),
}

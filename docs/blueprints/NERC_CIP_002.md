# 📘 Compliance Record of Note: NERC CIP-002-5.1a
## BES Cyber System Categorization

---

## 📋 Framework Overview
* **Framework ID**: `NERC_CIP_002`
...
> [!NOTE]
> This document serves as the official **Record of Note** and artifact for the NERC CIP-002-5.1a framework. All control questions, standard codes, and Purdue Model mappings are compiled directly from CSET definitions.

### Description
Mandatory standard to identify and categorize Bulk Electric System (BES) cyber systems into Impact levels.
